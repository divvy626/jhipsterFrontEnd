package com.cs.microservices.fe.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterFrontEnd");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterFrontEnd");
        ...
        config.getMapConfigs().put("com.cs.microservices.fe.domain.*", initializeDomainMapConfig(jHipsterProperties));
